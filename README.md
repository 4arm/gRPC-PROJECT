...
* **Latency Demo:** The client and server code include **timing/logging** features to measure request latency and server processing time.
...
3.  The server processes the request, introduces a small delay for demonstration, and streams back the `HelloReply`.

---
### Architecture Diagram & Communication Flow

![gRPC Service Architecture Diagram](https://github.com/user-attachments/assets/24e42d5a-c64a-4b51-98c7-c0f7681b9ce8)
...
├── server/
│   ├── greeter_server.py
│   ├── helloworld_pb2.py      # Generated by protoc
│   ├── helloworld_pb2_grpc.py # Generated by protoc
│   ├── Dockerfile
│   └── requirements.txt
│
├── client/
